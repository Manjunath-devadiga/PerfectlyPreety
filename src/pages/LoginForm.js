    ...
    <div style={{
      ...
      <form onSubmit={Loginsubmit}>
        <div style={{
          ...
          <h2 style={{ color: "#e91e63", textShadow: "1px 1px 2px #999" }}>Login to PrettyCosmetics</h2>
          <br />

          <div className="form-outline mb-4">
            <input ref={userInputEmail} type="email" placeholder="Enter your email" className="form-control"
              style={{ border: "2px solid #ce93d8", borderRadius: "6px" }} required />
          </div>

          <div className="form-outline mb-4">
            <input ref={userInputPassword} type="password" placeholder="Enter your password" className="form-control"
              style={{ border: "2px solid #ce93d8", borderRadius: "6px" }} required />
          </div>
